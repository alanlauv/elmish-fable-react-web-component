/// Example Elmish app from: https://github.com/Zaid-Ajaj/elmish-todo-part3
...
type Props =
  [<Emit("$0.todo")>] abstract TodoDesc : string
...
let init (props: Props) = {
  TodoList = [
    ...
    { Id = 3; Description = props.TodoDesc; Completed = false }
  ]
  NewTodo = ""
...
// Elmish App to React Component
let program = Program.mkSimple init update render
...
let TodoComponent = elmishToReact externalisedProgram
...
//      let todoFromAttribute = getAttribute "todo"

//      Program.mkSimple init update render
//      |> initReact mountPoint
//      |> Program.runWith todoFromAttribute // change init to accept a string

//      retargetEvents(shadowRoot)
//      ()

////CustomElements.define "todo-component" // This does the same as the line below
//window?customElements?define ("todo-component", jsConstructor<WebComponent>)