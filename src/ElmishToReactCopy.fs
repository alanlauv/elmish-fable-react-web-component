// I was unable to compile when using Fable.Elmish.ElmishToReact due to some strange compiler error.
// So I've just copied the source code and it seems to work.
// https://github.com/DouglasConnect/ElmishToReact/blob/master/ElmishToReact.fs

namespace Fable.Elmish.ElmishToReactCopy
